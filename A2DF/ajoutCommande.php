    ...
    <body>
        <div class="contenu">
            <div class="ribbon-wrapper">
                <a  href="listeCommande.php"><img class="img_liste" onmouseout="this.src = 'img/arrow_undo.png'" onmouseover="this.src = 'img/arrow_undo1.png'" src="img/arrow_undo.png" /></a>
                <div class="ribbon-front"><div class="titre">Ajout d'une commande</div></div>
            ...
            <form action='ajoutCommande.php' method='POST' name='formAjoutCommande'>
